      ...
      <div className="animation">
        <div className="man">
          <div className="upper-body">
            <img className="r-arm" src="/animation/r-arm.svg" alt="" />
            <img className="torso" src="/animation/torso.svg" alt="" />
            <div className="l-arm">
              <img className="l-up-arm" src="/animation/l-up-arm.svg" alt="" />
              <img
                className="l-low-arm"
          ...
          <div className="boat-legs-laptop-motor">
            <div className="motor">
              ...
              <img className="engine" src="/animation/engine.svg" alt="" />
            </div>
            <img
